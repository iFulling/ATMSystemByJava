        ...
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="transaction-form">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="handleWithdraw" :loading="loading">确认取款</el-button>
    ...
    methods: {
        ...
        handleWithdraw() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    this.loading = true;
                    api.user.withdraw(this.form.amount)
                        .then(response => {
                        ...
                        .catch(error => {
                            this.$message.error(error.response?.data?.message || '取款失败');
                        })
                        .finally(() => {
                            this.loading = false;
                        });
