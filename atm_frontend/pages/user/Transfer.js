            ...
            <el-card class="box-card">
                ...
                <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="transaction-form">
                    ...
                    <el-form-item label="对方账号" prop="toUserName">
                        <el-input v-model="form.toUserName" placeholder="请输入对方账号"></el-input>
                    </el-form-item>
    ...
    methods: {
        ...
        handleTransfer() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    this.loading = true;
                    api.user.transfer(this.form.amount, this.form.toUserName, this.form.remark)
                        .then(response => {
                        ...
                        .catch(error => {
                            this.$message.error(error.response?.data?.message || '转账失败');
                        })
                        .finally(() => {
                            this.loading = false;
                        });
